...
- Read: `Program.cs`, request/response models, service behavior, and current docs
...
- Allowed file: `docs/api-reference.md` only
...
2. Create or update `docs/api-reference.md`.
...
- [ ] `create-pull-request.allowed-files` permits only `docs/api-reference.md`.
